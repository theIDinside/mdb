...
impl MidasCommuncation {
    #[allow(unused)]
    pub fn new(input_stream: mpsc::Receiver<String>, output_stream: mpsc::Sender<String>) -> MidasCommuncation {
        MidasCommuncation {
...
impl Debugger {
    #[allow(unused)]
    pub fn new(communication: MidasCommuncation) -> Debugger {
        Debugger {
            target: None,
